    ...
    <div class="card my-3 shadow-lg rounded">
      <div class="container" v-if="role">
        ...
        <div class="row pt-3">
          <div class="col-md-8">
            <div class="row mb-3">
              <label class="col-sm-4 col-form-label text-secondary"> Role: </label>
              <div class="col-sm-8">
            ...
            <div class="row mb-3">
              <label class="col-sm-4 col-form-label text-secondary"> Permissions: </label>
              <div class="col-sm-8">
        ...
        <div class="text-end mt-4">
          ...
          <button class="btn btn-primary" @click="handleEditRole(role.id)">
