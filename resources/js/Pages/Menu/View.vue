    ...
    <div class="card my-5 shadow-lg rounded">
      <div class="container my-4" v-if="menu">
        ...
        <div class="row g-3">
          <div class="col-md-6">
            <div class="row mb-3">
              <label for="menu_label" class="col-sm-4 col-form-label text-secondary">Menu Name:</label>
              <div class="col-sm-8">
                <span id="menu_label" class="form-control-plaintext fw-bold">{{ menu.menu_label }}</span>
              </div>
            </div>
            <div class="row mb-3">
              <label for="menu_level" class="col-sm-4 col-form-label text-secondary">Level:</label>
              <div class="col-sm-8">
                <span id="menu_level" class="form-control-plaintext fw-bold">{{ menu.menu_level }}</span>
              </div>
            </div>
            <div class="row mb-3">
              <label for="menu_permission" class="col-sm-4 col-form-label text-secondary">Permission:</label>
              <div class="col-sm-8">
          ...
          <div class="col-md-6">
            <div class="row mb-3">
              <label for="menu_route" class="col-sm-4 col-form-label text-secondary">Route:</label>
              <div class="col-sm-8">
                <span id="menu_route" class="form-control-plaintext fw-bold">{{ menu.menu_route }}</span>
              </div>
            </div>
            <div class="row mb-3">
              <label for="menu_is_active" class="col-sm-4 col-form-label text-secondary">Status:</label>
              <div class="col-sm-8">
                <span
                  id="menu_is_active"
