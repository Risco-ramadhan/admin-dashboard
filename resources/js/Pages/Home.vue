                    ...
                    <div class="card p-3 shadow-sm border-0 shadow-lg">
                        ...
                        >
                            ...
                            <div class="rounded-circle bg-success p-3">
                                <i
                                    class="far fa-id-badge text-white"
                                    style="font-size: 1.5rem"
                                ></i>
                            </div>
                        </div>
                            ...
                            <div>
                                ...
                                <small class="text-muted">{{
                                    contractVendorCreated !== null
                                        ? contractVendorCreated
                                        : "Loading..."
                                }}</small>
                            </div>
                            <div class="rounded-circle bg-warning p-3">
                                <i
                                    class="fas fa-file-contract text-white"
                                    style="font-size: 1.5rem"
                                ></i>
                            </div>
                        </div>
        ...
        async fetch() {
            try {
                ...
                if (response.data.success) {
                    ...
                    this.contractVendorCount =
                        response.data.render.contract_vendor_count;
                    this.contractVendorCreated =
                        response.data.render.contract_vendor_created;
                } else {
